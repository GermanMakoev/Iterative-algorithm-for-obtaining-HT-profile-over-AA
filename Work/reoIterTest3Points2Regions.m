...
for k = 1:length(freqs)
    ...
    Robs(k,l) = scanR(Points(l));
    posR(k,l) = Points(l);
    Lobs(k,l) = scanL(Points(l));
    posL(k,l) = Points(l);
end
end
...
Ht1 = [1.2 1.4 1.5 1.6 1.8 2.0 2.2 2.4 2.6 2.8 3.0 3.5 4.0 4.5 5.0 5.5  6 10 15]*1e8;
Ht2 = [1.6 1.8 1.9 2.0 2.1 2.3 2.5 2.7 2.9 3.1 3.7 4.2 4.7 5.2 5.7 6.5 10 15 20]*1e8;
...
param.wTemp_D = 1e-3;
param.rescntmax = 70;
reoIterationCore3Points2Regions(hLib, mfoData, M, freqs, Robs, Lobs, H0, T0, Hb, Tb, Ht1, Ht2, Hc, Tc, NT, posR, posL, Mask, param, diagrH, diagrV, gridstep, Points);
