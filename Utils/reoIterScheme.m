...
mfoData = mfoLoadField('c:\path2SDO\12470_hmi.M_720s.20151218_082209.W85N13CR.CEA.NAS_1000_sst.sav'); % for az=+12, +10
if isempty(mfoData)
    return
end
...
ratan = iouLoadRATANData('c:\path2RATAN\RATAN_AR12470_20151218_082624_az+10_SPECTRA__flocculae-included_stille_appr.dat');
